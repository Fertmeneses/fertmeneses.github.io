...
<div style="display: flex; align-items: center; gap: 10px;">
  <div style="flex: 2.5;">
    <p><strong>Quantum diamond magnetometry</strong>, a sensing technique based on atomic defects in a diamond lattice, is a powerful tool to the <strong>magnetic environment</strong> of a sample and extract information about the <strong>noise spectral density</strong>. 
